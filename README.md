...
- [ ] **Vocabulary quality Phase 3: quality audit** — Astra, high reasoning. **80 / 100 inspected** (forty per level); the first ten records' corrections were applied in Phase 2; chunks 2–8 await Phase 4, including active counter-reading errors, a wrong dictionary match, and extra する in word ruby. Resume sample position 41 per level. [Findings and next chunk](docs/phase3-vocabulary-audit.md); [fixed sample](docs/phase3-vocabulary-sample.json). Continue in bounded batches sized to the user's credit budget, pausing between batches.
