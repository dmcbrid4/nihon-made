...
- [ ] **Vocabulary quality Phase 2: implementation** — Terra, high reasoning. Normalize lexical senses and examples, preserve provenance, add structured word/sentence furigana and rendering, validation reports, useful priority, and stable history compatibility.
