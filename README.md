...
- [x] **Vocabulary quality Phase 2: candidate implementation** — Terra, high reasoning. Added structured word/sentence furigana and rendering, provenance/review fields, validation and review reports, curriculum priority, and history-safe retirement. The [quality report](docs/data-quality-report.md) identifies the remaining editorial work before release.
- [ ] **Vocabulary quality Phase 3: quality audit** — Astra, high reasoning. Review 100 reproducibly sampled records plus high-risk cases; identify systematic corrections.
