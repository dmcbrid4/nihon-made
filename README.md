...
- [ ] **Vocabulary quality Phase 3: quality audit** — Astra, high reasoning. **12 / 100 inspected** (six per level); the first ten records' corrections were applied in Phase 2; two further records await Phase 4. Resume sample position 7 per level. [Findings and next chunk](docs/phase3-vocabulary-audit.md); [fixed sample](docs/phase3-vocabulary-sample.json). Continue in ten-record chunks, pausing between chunks for the user's credit budget.
