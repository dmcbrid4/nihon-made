...
- [ ] **Vocabulary quality Phase 3: quality audit** — Astra, high reasoning. **70 / 100 inspected** (thirty-five per level); the first ten records' corrections were applied in Phase 2; chunks 2–7 await Phase 4, including active counter-reading errors, a wrong dictionary match, and extra する in word ruby. Resume sample position 36 per level. [Findings and next chunk](docs/phase3-vocabulary-audit.md); [fixed sample](docs/phase3-vocabulary-sample.json). Continue in bounded batches sized to the user's credit budget, pausing between batches.
