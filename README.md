...
- [ ] **Vocabulary quality Phase 3: quality audit** — Astra, high reasoning. **50 / 100 inspected** (twenty-five per level); the first ten records' corrections were applied in Phase 2; chunks 2–5 await Phase 4, including active counter-reading errors, a wrong dictionary match, and extra する in word ruby. Resume sample position 26 per level. [Findings and next chunk](docs/phase3-vocabulary-audit.md); [fixed sample](docs/phase3-vocabulary-sample.json). Continue in ten-record chunks, pausing between chunks for the user's credit budget.
