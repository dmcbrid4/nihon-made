...
- [ ] **Vocabulary quality Phase 3: quality audit** — Astra, high reasoning. **20 / 100 inspected** (ten per level); the first ten records' corrections were applied in Phase 2; chunk 2 corrections await Phase 4, including active counter-reading errors. Resume sample position 11 per level. [Findings and next chunk](docs/phase3-vocabulary-audit.md); [fixed sample](docs/phase3-vocabulary-sample.json). Continue in ten-record chunks, pausing between chunks for the user's credit budget.
