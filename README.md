...
- [ ] **Vocabulary quality Phase 4: corrections and verification** — Terra, high reasoning, then Astra recheck. Follow the [prioritized correction handoff](docs/phase4-vocabulary-corrections.md), repair affected groups, rerun checks and report remaining uncertainties and rendered examples. Keep work on `dev`; no automatic production rollout.
