...
- [x] **Curriculum infrastructure and N5/N4 modes** — GPT-5.6 Terra, high reasoning. The candidate currently contains 736 N5 and 707 N4-only vocabulary records, alongside other study content. Modes keep queues, sessions, collections, and progress distinct. The content quality work below remains incomplete.
...
- [ ] **Vocabulary quality Phase 2: finish candidate implementation** — Terra, high reasoning. Annotation/rendering infrastructure exists, but Phase 3 found incomplete sense reconciliation, provenance, validation, and approval gating. See the [correction requirements](docs/phase3-vocabulary-audit.md) before calling this phase complete.
- [ ] **Vocabulary quality Phase 3: quality audit** — Astra, high reasoning. **10 / 100 inspected** (five per level). [Findings and next chunk](docs/phase3-vocabulary-audit.md); [fixed sample](docs/phase3-vocabulary-sample.json). Continue in ten-record chunks, pausing between chunks for the user's credit budget.
