...
- [ ] **Vocabulary quality Phase 3: quality audit** — Astra, high reasoning. **30 / 100 inspected** (fifteen per level); the first ten records' corrections were applied in Phase 2; chunks 2–3 await Phase 4, including active counter-reading errors, a wrong dictionary match, and extra する in word ruby. Resume sample position 16 per level. [Findings and next chunk](docs/phase3-vocabulary-audit.md); [fixed sample](docs/phase3-vocabulary-sample.json). Continue in ten-record chunks, pausing between chunks for the user's credit budget.
