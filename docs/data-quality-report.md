...
| Catalog total | 1409 |
| **Approved/active N5 records (what learners study)** | **581** |
| **Approved/active N4-only records (what learners study)** | **566** |
| **Approved/active total** | **1147** |
| Not approved (quarantined for Phase 3/4) | 262 |
| Retired records | 43 |
...
| Repeated example groups | 75 |
| Records in editorial review queue (unapproved or flagged) | 1368 |
| Fallback (placeholder) examples remaining | 124 |
| Examples without a validated target span | 135 |
| Uncertain word/sentence furigana segmentations | 388 |

## Provenance

| Measurement | Result |
| --- | ---: |
| Records matched to a full-JMdict entry | 1396 of 1409 |
| Matched entries with no confirmed sense (zero gloss overlap with the stored meaning) | 67 |
| Examples with recovered Tatoeba sentence attribution | 114 |
| Imported examples still lacking recovered attribution | 1118 |

## Why records are not approved

| Reason | Records |
| --- | ---: |
| no validated target span in the example | 135 |
